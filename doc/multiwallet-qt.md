...
In order to support loading of multiple wallets in primestone-qt, a few changes in the UI architecture will be needed.
...
----------------------
primestone.cpp is the entry point into primestone-qt, and as such, will require some minor modifications to provide hooks for
