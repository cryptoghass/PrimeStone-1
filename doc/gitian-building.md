...
- [Building PrimeStone](#building-primestone)
...
Clone the git repositories for primestone and gitian and then checkout the primestone version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/primestone-crypto/primestone.git
cd primestone
...
Follow the instructions in [doc/release-process.md](release-process.md) in the primestone repository
...
To build PrimeStone (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the primestone repository.
...
```bash
    ...
    From https://github.com/primestone-crypto/primestone
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/primestone-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/primestone-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/primestone-build.assert
```
...
[primestone/gitian.sigs](https://github.com/primestone-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
