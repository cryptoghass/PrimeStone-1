...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<primestone_address\> \<monthly_payment_primestone\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<primestone_address\> \<monthly_payment_primestone\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` PrimeStone.
